  ...
  return (
    <header className="sticky top-0 z-50 flex w-full min-h-[96px] items-center justify-between px-12 py-4 bg-[#0b49d4] shadow-[0_10px_30px_rgba(0,0,0,0.18)]">
      <div className="inline-flex items-center gap-4 relative flex-[0_0_auto]">
        ...
        <Link href="/" className="inline-flex flex-col items-start relative flex-[0_0_auto] hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 rounded-sm">
