...
const steps: Step[] = [
  {
    ...
    description:
      'Complete and submit your formal application and supporting documents.',
...
function RoadmapNode({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute left-1/2 -translate-x-1/2 w-56 ${side === 'below' ? 'top-full mt-5' : 'bottom-full mb-5'}`}
      >
        <div className="bg-white rounded-2xl p-4 shadow-lg shadow-slate-200/60 border border-slate-100 text-center">
